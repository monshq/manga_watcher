defmodule MangaWatcherWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MangaWatcherWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MangaWatcherWeb.Gettext, "errors", msg, opts)
    end
  end
